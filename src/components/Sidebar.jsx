...
const Sidebar = () => {
  ...
  const userMenuItems = [
    { icon: Users, label: "Live Interview", active: false, path: "/live-interview" },
    { icon: Target, label: "Mock Interview", active: true, path: "/home" },
    // { icon: BookOpen, label: "Preparation Hub", active: false, path: "/preparation-hub" },
    { icon: BookOpen, label: "Preparation Hub",route: "/preparation-hub" },
    { icon: FileText, label: "Document Center", active: false, path: "/document-center" },
    { icon: Scan, label: "ATS Score Checker", active: false, path: "/ats-checker" }, // Add path for ATS Checker
  ];

  const adminMenuItems = [
    { icon: PlusCircle, label: "Add Question Bank", active: true, path: "/add-question-bank" },
    { icon: ClipboardList, label: "Add Entries", active: false, path: "/add-entries" },
